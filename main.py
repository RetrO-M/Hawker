...
from socket import AF_INET, SOCK_STREAM, error, gaierror, gethostbyname, socket
...
from requests import RequestException, Session, exceptions, get, post
...
class Hawker:
    ...
    def search_webcams(self, query, num_results=10):
        ...
        try:
            print(
                f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTCYAN_EX} Search with URL{Fore.LIGHTWHITE_EX} :{Fore.LIGHTGREEN_EX} {url_with_params}"
            )
            ...
            print(
                f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTRED_EX} Error while searching '{query}' : {e}"
            )
            return []
    ...
    def search_ahmia(self, text, timeout=10):
        try:
            ...
            if ahmia_results:
                ...
                print(
                    f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTRED_EX} No .onion links found on Ahmia for '{text}'."
                )
        except RequestException as e:
            print(
                f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTRED_EX} Failed to retrieve results from Ahmia: {e}"
            )
    ...
    def check_chess_email(self, email):
        ...
        try:
            ...
            if data.get("isEmailAvailable") == True:
                print(
                    f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTRED_EX} No Chess.com account"
                )
            elif data.get("isEmailAvailable") == False:
                print(
                    f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Chess.com Account Found"
                )
            else:
                print(
                    f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Chess.com account"
                )
        except:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if '{"users":[]}' in text_response:
                    print(
                        f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTRED_EX} No Duolingo account"
                    )
                else:
                    valid = response.json()["users"][0]["username"]
                    print(
                        f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Duolingo Account Found"
                    )
        ...
        if api_keys:
            for key in api_keys:
                ...
                try:
                    ...
                    if "user" in data:
                        print(
                            f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} https://www.flickr.com/people/{data['user']['nsid']}/"
                        )
                        flickr_found = True
                        break
                except:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if result["total_count"] > 0:
                    print(
                        f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} https://github.com/{result['items'][0]['login']}"
                    )
                else:
                    print(
                        f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTRED_EX} No GitHub account"
                    )
        except Exception as e:
            pass
    ...
    def check_gravatar_email(self, email):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(
                    f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} https://gravatar.com/{display_name}"
                )
            elif response.status_code == 404:
                print(
                    f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTRED_EX} No Gravatar account"
                )
        except Exception as e:
            pass
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if data["resource_response"]["data"]:
                    print(
                        f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Pinterest Account Found"
                    )
                else:
                    print(
                        f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTRED_EX} No Pinterest account"
                    )
            else:
                print(
                    f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTRED_EX} No Pinterest account"
        ...
        try:
            with Session() as session:
                ...
                if response_json.get("email") == "create_account_passed":
                    print(
                        f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTRED_EX} No Pornhub account"
                    )
                elif response_json.get("email") == "create_account_failed":
                    print(
                        f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Pornhub Account Found"
                    )
                else:
                    print(
                        f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTRED_EX} No Pornhub account"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if responseData.get("status") == 20:
                    print(
                        f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Spotify Account Found"
                    )
                else:
                    print(
                        f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTRED_EX} No Spotify account"
                    )
            else:
    ...
    def check_twitter_email(self, email):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if not data["valid"]:
                    print(
                        f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Twitter Account Found"
                    )
                else:
                    print(
                        f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTRED_EX} No Twitter account"
                    )
        except Exception as e:
            pass
    ...
    def wordpress_email(self, email):
        ...
        if '"email_verified":true' in response.text:
            print(
                f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Wordpress Account Found"
            )
        else:
    ...
    def get_email_info(self, email):
        ...
        if stealers_data:
            for data in stealers_data:
                ...
                print(
                    f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Computer Name{Fore.LIGHTYELLOW_EX} :{Fore.LIGHTWHITE_EX} ",
                    computer_name,
                )
                print(
                    f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Operating System{Fore.LIGHTYELLOW_EX} :{Fore.LIGHTWHITE_EX} ",
                    operating_system,
                )
                print(
                    f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} IP{Fore.LIGHTYELLOW_EX} :{Fore.LIGHTWHITE_EX} ",
                    ip,
                )
                print(
                    f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Malware Path{Fore.LIGHTYELLOW_EX} :{Fore.LIGHTWHITE_EX} ",
                    malware_path,
                )
                print(
                    f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Date Compromised{Fore.LIGHTYELLOW_EX} :{Fore.LIGHTWHITE_EX} ",
                    date_compromised,
                )
                print(
                    f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} AntiViruses{Fore.LIGHTYELLOW_EX} :{Fore.LIGHTWHITE_EX} ",
                    antiviruses,
                )
        else:
        ...
        if resp.status_code == 200:
            try:
                ...
                if isinstance(data, list) and len(data) == 0:
                    print(
                        f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTRED_EX} No Pastebin dumps"
                    )
                else:
                    for result in data:
                        print(
                            f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} https://pastebin.com/{Fore.LIGHTCYAN_EX}{result.get('id')}"
                        )
    ...
    def instagram_search(self, text):
        ...
        try:
            ...
            for a in soup.find_all("a", href=True):
                ...
                if href.startswith("/url?q="):
                    link = href.split("/url?q=")[1].split("&")[0]
                    if "instagram.com" in link and not any(
                        sub in link
                        for sub in [
                            "google.com",
                            "translate.google.com",
    ...
    def youtube_search(self, text):
        ...
        try:
            ...
            for a in soup.find_all("a", href=True):
                ...
                if href.startswith("/url?q="):
                    link = href.split("/url?q=")[1].split("&")[0]
                    if "youtube.com" in link and not any(
                        sub in link
                        for sub in [
                            "google.com",
                            "translate.google.com",
    ...
    def pagesjaunes_search(self, fullname):
        ...
        try:
            ...
            for a in soup.find_all("a", href=True):
                ...
                if href.startswith("/url?q="):
                    link = href.split("/url?q=")[1].split("&")[0]
                    if "pagesjaunes.fr" in link and not any(
                        sub in link
                        for sub in [
                            "google.com",
                            "translate.google.com",
    ...
    def whitepages_search(self, fullname):
        ...
        try:
            ...
            for a in soup.find_all("a", href=True):
                ...
                if href.startswith("/url?q="):
                    link = href.split("/url?q=")[1].split("&")[0]
                    if "whitepages.com" in link and not any(
                        sub in link
                        for sub in [
                            "google.com",
                            "translate.google.com",
    ...
    def get_detailed_phone_info(self, phone):
        try:
            ...
            phone_info = {
                ...
                "Validated Number": format_number(
                ...
                "National Format": format_number(
                    parsed_number, PhoneNumberFormat.NATIONAL
                ),
                "RFC3966 Format": format_number(
                    parsed_number, PhoneNumberFormat.RFC3966
                ),
                "Is Premium Rate": (
                    "Yes"
                    if number_type(parsed_number) == PhoneNumberType.PREMIUM_RATE
                    else "No"
                ),
            ...
            phone_info["Is Mobile"] = (
                number_type(parsed_number) == PhoneNumberType.MOBILE
            )
            phone_info["Is Fixed Line"] = (
                number_type(parsed_number) == PhoneNumberType.FIXED_LINE
            )
    ...
    def geolocation_ip(self, ip):
        ...
        try:
            ...
            if response.status_code == 200:
                data = response.json()
                print(
                    f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Country:{Fore.LIGHTWHITE_EX} {data.get('country_name', 'Not specified')}"
                )
                print(
                    f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} City:{Fore.LIGHTWHITE_EX} {data.get('city', 'Not specified')}"
                )
                print(
                    f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Postal code:{Fore.LIGHTWHITE_EX} {data.get('postal', 'Not specified')}"
                )
                print(
                    f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Latitude:{Fore.LIGHTWHITE_EX} {data.get('latitude', 'Not specified')}"
                )
                print(
                    f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Longitude:{Fore.LIGHTWHITE_EX} {data.get('longitude', 'Not specified')}"
                )

            else:
                print(
                    f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTRED_EX} Error {response.status_code}: Unable to retrieve information."
                )
    ...
    def create_map(self, lat, lon, zoom_start=12):
        ...
        print(
            f"{Fore.LIGHTWHITE_EX}[ + ] The map has been created and saved in 'map.html'. Open this file in your browser."
        )
    ...
    def get_bitcoin_info(self, address):
        ...
        try:
            ...
            if response.status_code != 200:
                print(
                    f"{Fore.LIGHTRED_EX}[ERROR]{Fore.LIGHTWHITE_EX} ERROR : {response.status_code}"
                )
                return
            ...
            print(
                f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Bitcoin{Fore.LIGHTWHITE_EX} :{Fore.LIGHTGREEN_EX} {address}"
            )
            print(
                f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Total Balance {Fore.LIGHTWHITE_EX}:{Fore.LIGHTGREEN_EX} {total_balance} BTC"
            )
            print(
                f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Total Transactions {Fore.LIGHTWHITE_EX}: {Fore.LIGHTGREEN_EX}{total_transactions}"
            )
            print(
                f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Total Received{Fore.LIGHTWHITE_EX} : {Fore.LIGHTGREEN_EX}{total_received} BTC"
            )
            print(
                f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Total Sent {Fore.LIGHTWHITE_EX}:{Fore.LIGHTGREEN_EX} {total_sent} BTC"
            )
            print(
                f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} First Transaction (timestamp) {Fore.LIGHTWHITE_EX}:{Fore.LIGHTGREEN_EX} {first_tx_time}"
            )
    ...
    def search_tor66_all_links(self, address, timeout=10):
        try:
            ...
            if tor66_results:
                print(
                    f"{Fore.LIGHTCYAN_EX}[WAIT]{Fore.LIGHTWHITE_EX} Found {len(tor66_results)} relevant links on Tor66 for '{address}':"
                )
                for result in tor66_results:
                    print(
                        f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Title:{Fore.LIGHTWHITE_EX} {result['title']}"
                    )
                    print(
                        f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Description:{Fore.LIGHTWHITE_EX} {result['description']}"
                    )
                    print(
                        f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Link:{Fore.LIGHTWHITE_EX} {result['link']}\n"
                    )
            else:
                print(
                    f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTRED_EX} No relevant links found on Tor66 for '{address}'."
                )
        except RequestException as e:
            print(
                f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTRED_EX} Error occurred: {str(e)}"
            )
    ...
    def analyze_website(self, url, tor_proxies):
        ...
        for keyword in self.MALICIOUS_KEYWORDS:
            if keyword in content.lower():
                print(
                    f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Found :{Fore.LIGHTMAGENTA_EX} {keyword}"
                )
    ...
    def grab_email(self, url, tor_proxies):
        ...
        if emails:
            print(
                f"{Fore.LIGHTWHITE_EX}[ + ] Email addresses found on{Fore.LIGHTMAGENTA_EX} {url}{Fore.LIGHTWHITE_EX}:"
            )
            for email in emails:
                print(
                    f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Email{Fore.LIGHTWHITE_EX} :{Fore.LIGHTMAGENTA_EX} {email}"
                )
        else:
            print(
                f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTRED_EX} No email address found on : {url}."
            )
    ...
    def send_payload(self, form_details, url, payload, tor_proxies):
        ...
        for input in form_details["inputs"]:
            ...
            if input_name:
                data[input_name] = (
                    payload if input["type"] in ["text", "search"] else ""
                )

        print(
            f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Sending payload to{Fore.LIGHTMAGENTA_EX} {target_url}"
        )
        print(
            f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Submitted data:{Fore.LIGHTWHITE_EX} {data}"
        )

        if form_details["method"] == "post":
            return post(
                target_url, headers=self.headers, data=data, proxies=tor_proxies
            )
        else:
            return get(
                target_url, headers=self.headers, params=data, proxies=tor_proxies
            )

    def xss_scan(self, url, tor_proxies):
        forms = self.find_forms(url)
        print(
            f"{Fore.LIGHTWHITE_EX}[ + ] Found{Fore.LIGHTMAGENTA_EX} {len(forms)}{Fore.LIGHTWHITE_EX} forms on{Fore.LIGHTMAGENTA_EX} {url}{Fore.LIGHTWHITE_EX}."
        )
        ...
        for payload in self.payloads_xss:
            for form in forms:
                ...
                response_content = self.send_payload(
                    form_details, url, payload, tor_proxies
                ).content.decode()

                if payload in response_content:
                    print(
                        f"{Fore.LIGHTWHITE_EX}[ + ] XSS detected on{Fore.LIGHTMAGENTA_EX} {url} {Fore.LIGHTWHITE_EX}with payload:{Fore.LIGHTMAGENTA_EX} {payload}"
                    )
        ...
        if vulnerabilities_found:
            ...
            print(
                f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTRED_EX}  No XSS vulnerabilities found."
            )

    def sql_injection_scan(self, url, tor_proxies):
        forms = self.find_forms(url)
        print(
            f"{Fore.LIGHTWHITE_EX}[ + ]{Fore.LIGHTMAGENTA_EX} {len(forms)}{Fore.LIGHTWHITE_EX} forms found on{Fore.LIGHTMAGENTA_EX} {url}{Fore.LIGHTWHITE_EX}."
        )
        vulnerabilities_found = []
        ...
        for payload in self.sqli_payloads:
            for form in forms:
                ...
                if (
                    ...
                    or "syntax" in response_content.lower()
                ):
                    print(
                        f"{Fore.LIGHTWHITE_EX}[ + ]  SQL Injection detected on{Fore.LIGHTMAGENTA_EX} {url}{Fore.LIGHTWHITE_EX} with payload: {Fore.LIGHTMAGENTA_EX}{payload}"
                    )
                    print(f"{Fore.LIGHTWHITE_EX}[ + ] Form details:")
                    pprint(form_details)
        ...
        if vulnerabilities_found:
            ...
            print(
                f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTRED_EX}  No SQL injection vulnerabilities found."
            )
    ...
    def check_security_misconfiguration(self, url, tor_proxies):
        ...
        for file in sensitive_files:
            ...
            if response.status_code == 200:
                print(
                    f"{Fore.LIGHTWHITE_EX}[ + ]{Fore.LIGHTGREEN_EX} Sensitive file found:{Fore.LIGHTMAGENTA_EX} {url + file}"
                )
            else:
                print(
                    f"{Fore.LIGHTWHITE_EX}[ + ]{Fore.LIGHTRED_EX} No sensitive file found: {url + file}"
                )
...
if __name__ == "__main__":
    ...
    try:
        while True:
            print(
                f"{Fore.LIGHTMAGENTA_EX}┌────{Fore.MAGENTA}({Fore.LIGHTGREEN_EX}@{Fore.RED}user{Fore.MAGENTA}){Fore.LIGHTWHITE_EX}-{Fore.MAGENTA}[{Fore.LIGHTGREEN_EX}/{Fore.LIGHTMAGENTA_EX}hawker{Fore.MAGENTA}]"
            )
            command = input(
                f"{Fore.LIGHTMAGENTA_EX}└───{Fore.MAGENTA}>{Fore.LIGHTGREEN_EX} "
            )
            ...
            if command == "01" or command == "1":
                ...
                for dork in dork_tool.dorks:
                    ...
                    if results:
                        for i, link in enumerate(results, 1):
                            print(
                                f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTCYAN_EX} {i}.{Fore.LIGHTWHITE_EX} {link}"
                            )
                        all_results.extend(results)
                    else:
                        print(
                            f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTRED_EX} No results found for '{dork}'."
                        )
                ...
                if all_results:
                    ...
                    print(
                        f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTRED_EX} No results found for all dorks."
                    )
            elif command == "02" or command == "2":
                email = input(
                    f" {Fore.LIGHTWHITE_EX}└ {Fore.LIGHTGREEN_EX}EMAIL{Fore.LIGHTCYAN_EX} :{Fore.LIGHTWHITE_EX} "
                )
                start_time()
                haw.title()
                ...
                if search_results:
                    print(
                        f"{Fore.LIGHTWHITE_EX}[ + ] Found{Fore.LIGHTMAGENTA_EX} {len(search_results)}{Fore.LIGHTWHITE_EX} URLs of doxbin.org"
                    )
                    for link in search_results:
                        if "doxbin.org" in link:
                            print(
                                f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Doxbin.org{Fore.LIGHTMAGENTA_EX} :{Fore.LIGHTGREEN_EX} {link}"
                            )
                print(
                    f"{Fore.LIGHTWHITE_EX}[ + ] Result of Social Networking Sites Linked to Email:"
                )
                ...
                if instagram_results:
                    print(
                        f"{Fore.LIGHTWHITE_EX}[ + ] Found{Fore.LIGHTMAGENTA_EX} {len(instagram_results)}{Fore.LIGHTWHITE_EX} URLs of instagram.com"
                    )
                    for link in instagram_results:
                        if "instagram.com" in link:
                            print(
                                f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Instagram.com{Fore.LIGHTMAGENTA_EX} :{Fore.LIGHTGREEN_EX} {link}"
                            )

                twitter_results = haw.twitter_search(email)
                if twitter_results:
                    print(
                        f"{Fore.LIGHTWHITE_EX}[ + ] Found{Fore.LIGHTMAGENTA_EX} {len(twitter_results)}{Fore.LIGHTWHITE_EX} URLs of X.com"
                    )
                    for link in twitter_results:
                        if "x.com" in link:
                            print(
                                f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} X.com{Fore.LIGHTMAGENTA_EX} :{Fore.LIGHTGREEN_EX} {link}"
                            )

                youtube_results = haw.youtube_search(email)
                if youtube_results:
                    print(
                        f"{Fore.LIGHTWHITE_EX}[ + ] Found {Fore.LIGHTMAGENTA_EX}{len(youtube_results)}{Fore.LIGHTWHITE_EX} URLs of youtube.com"
                    )
                    for link in youtube_results:
                        if "youtube.com" in link:
                            print(
                                f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Youtube.com{Fore.LIGHTMAGENTA_EX} :{Fore.LIGHTGREEN_EX} {link}"
                            )

                facebook_results = haw.facebook_search(email)
                if facebook_results:
                    print(
                        f"{Fore.LIGHTWHITE_EX}[ + ] Found{Fore.LIGHTMAGENTA_EX} {len(facebook_results)}{Fore.LIGHTWHITE_EX} URLs of facebook.com"
                    )
                    for link in facebook_results:
                        if "facebook.com" in link:
                            print(
                                f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} FaceBook.com{Fore.LIGHTMAGENTA_EX} :{Fore.LIGHTGREEN_EX} {link}"
                            )
                haw.search_ahmia(email)
            elif command == "03" or command == "3":
                fullname = input(
                    f" {Fore.LIGHTWHITE_EX}└ {Fore.LIGHTGREEN_EX}Full Name{Fore.LIGHTCYAN_EX} :{Fore.LIGHTWHITE_EX} "
                )
                start_time()
                ...
                print(
                    f"{Fore.LIGHTWHITE_EX}[ + ] Searching for{Fore.LIGHTMAGENTA_EX} {fullname}{Fore.LIGHTWHITE_EX}"
                )
                file_types = [
                    "pdf",
                    "xlsx",
                ...
                for file_type in file_types:
                    ...
                    if search_results:
                        for link in search_results:
                            print(
                                f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} {file_type.upper()} {Fore.LIGHTMAGENTA_EX}- {Fore.LIGHTWHITE_EX}{link}"
                            )
                ...
                if pagesjaunes_results:
                    print(
                        f"{Fore.LIGHTWHITE_EX}[ + ] Found{Fore.LIGHTMAGENTA_EX} {len(twitter_results)}{Fore.LIGHTWHITE_EX} URLs of pagesjaunes.fr"
                    )
                    for link in pagesjaunes_results:
                        if "pagesjaunes.fr" in link:
                            print(
                                f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} PageJaunes.fr{Fore.LIGHTMAGENTA_EX} :{Fore.LIGHTGREEN_EX} {link}"
                            )

                whitepages_results = haw.whitepages_search(fullname)
                if whitepages_results:
                    print(
                        f"{Fore.LIGHTWHITE_EX}[ + ] Found{Fore.LIGHTMAGENTA_EX} {len(twitter_results)}{Fore.LIGHTWHITE_EX} URLs of whitepages.com"
                    )
                    for link in whitepages_results:
                        if "whitepages.com" in link:
                            print(
                                f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} whitepages.com{Fore.LIGHTMAGENTA_EX} :{Fore.LIGHTGREEN_EX} {link}"
                            )
            elif command == "04" or command == "4":
                phone = input(
                    f" {Fore.LIGHTWHITE_EX}└ {Fore.LIGHTGREEN_EX}Phone{Fore.LIGHTCYAN_EX} :{Fore.LIGHTWHITE_EX} "
                )
                start_time()
                haw.title()
                ...
                for key, value in result.items():
                    print(
                        f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} {key} {Fore.LIGHTMAGENTA_EX}:{Fore.LIGHTGREEN_EX} {value}"
                    )
                ...
                ip = input(
                    f" {Fore.LIGHTWHITE_EX}└ {Fore.LIGHTGREEN_EX}IP{Fore.LIGHTCYAN_EX} :{Fore.LIGHTWHITE_EX} "
                )
                start_time()
                haw.title()
                ...
                try:
                    ...
                    print(
                        f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTRED_EX} An error occurred: {e}"
                    )
            elif command == "06" or command == "6":
                address = input(
                    f" {Fore.LIGHTWHITE_EX}└ {Fore.LIGHTGREEN_EX}Bitcoin Address{Fore.LIGHTCYAN_EX} :{Fore.LIGHTWHITE_EX} "
                )
                start_time()
                haw.title()
                ...
                url = input(
                    f" {Fore.LIGHTWHITE_EX}└ {Fore.LIGHTGREEN_EX}URL{Fore.LIGHTCYAN_EX} :{Fore.LIGHTWHITE_EX} "
                )
                proxy = input(
                    f'   {Fore.LIGHTWHITE_EX}└ {Fore.LIGHTGREEN_EX}PROXY{Fore.LIGHTCYAN_EX}(PROXIES TOR : 127.0.0.1:9050, Type "Enter" if you dont want to use it) :{Fore.LIGHTWHITE_EX} '
                )
                start_time()
                haw.title()
                tor_proxies = (
                    {"http": f"socks5h://{proxy}", "https": f"socks5h://{proxy}"}
                    if proxy
                    else None
                )
                ...
                print(
                    f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Title      {Fore.LIGHTCYAN_EX} : {Fore.LIGHTWHITE_EX}{info.get('Title', 'N/A')}"
                )
                print(
                    f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} Description {Fore.LIGHTCYAN_EX}: {Fore.LIGHTWHITE_EX}{info.get('Description', 'N/A')}"
                )
                ...
                if subdomains_with_ips:
                    print(
                        f"{Fore.LIGHTWHITE_EX}[ + ] Subdomains and IP addresses for{Fore.LIGHTMAGENTA_EX} {domain}{Fore.LIGHTWHITE_EX}:"
                    )
                    for subdomain, ip in subdomains_with_ips:
                        os_name = haw.detect_os(ip)
                        print(
                            f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} {subdomain}{Fore.LIGHTWHITE_EX} -{Fore.LIGHTGREEN_EX} {ip}{Fore.LIGHTWHITE_EX} -{Fore.LIGHTYELLOW_EX} {os_name}"
                        )
                        ip_url = f"http://{ip}"
                        resp = get(ip_url, headers=haw.headers, proxies=tor_proxies)
                        print(
                            f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTGREEN_EX} {ip_url}{Fore.LIGHTMAGENTA_EX} - {Fore.LIGHTGREEN_EX} ",
                            resp.status_code,
                        )
                else:
                    print(
                        f"{Fore.LIGHTWHITE_EX}    •{Fore.LIGHTRED_EX} No subdomains found for {domain}."
                    )
